...
#print("Getting into Portfolio Optimization")
...
opt <- optimize.portfolio(R, portfolio=pspec,optimize_method = "ROI", trace= TRUE)
...
#rr <- Return.portfolio(R, weights = extractWeights(opt))
